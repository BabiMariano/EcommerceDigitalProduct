{{-- Se o user estiver autenticado é posivel puxar as info sobre ele pelo method auth q está recebendo os dados sobre o user no controller login --}}
...
<!-- Dropdown Structure -->
    ...
    <ul id="slide-out" class="sidenav " >
        ...
        {{-- o asset irá encontrar o arquivo dentro do public --}}
